...
Namespace ConnectDB
    Public Class SqlDB
        ...
        End Function
        Public Shared Function SetDate(ByVal DateIn As DateTime) As String
        ...
        Public Shared Function SetDate(DateIn As String) As String
...
#Region "Config DB"
        ...
        '    Get
        '        Dim INIFlie As String = "C:\Windows\TKS60th.ini"
        ...
        '        Return DeCripPwd(ini.ReadString("DBServerName"))
        '    End Get
        'End Property
        'Public Shared ReadOnly Property DBDatabaseName() As String
        '    Get
        '        Dim ini As IniReader = INIFileName
        '        Return DeCripPwd(ini.ReadString("DBDatabaseName"))
        '    End Get
        'End Property
        ...
        '    Get
        '        Dim ini As IniReader = INIFileName
        '        Return DeCripPwd(ini.ReadString("DBDbUserID"))
        '    End Get
        'End Property
